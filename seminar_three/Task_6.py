...
class ConcreteDecoratorA(Decorator):
    def operation(self):
        return f"ConcreteDecoratorA: предварительная операция A\n" \
               f"{super().operation()}\nConcreteDecoratorA: дополнительная операция A"


class ConcreteDecoratorB(Decorator):
    def operation(self):
        return f"ConcreteDecoratorB: предварительная операция B\n" \
               f"{super().operation()}\nConcreteDecoratorB: другая дополнительная операция B"
